...
extern unsigned long zfs_arc_dnode_limit_percent;
...
arc_prune_t *
libuzfs_register_arc_prune(arc_prune_func_t *arc_prune, void *arg)
{
	return (arc_add_prune_callback(arc_prune, arg));
}

void
libuzfs_unregister_arc_prune(arc_prune_t *ap)
{
	arc_remove_prune_callback(ap);
}
