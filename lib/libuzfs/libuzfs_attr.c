...
sa_attr_reg_t uzfs_attr_table[UZFS_END+1] = {
	...
	{"UZFS_NSID", sizeof (uint32_t), SA_UINT32_ARRAY, 9},
	{"UZFS_DSID", sizeof (uint32_t), SA_UINT32_ARRAY, 10},
	{"UZFS_OID", sizeof (uint64_t), SA_UINT64_ARRAY, 11},
	{"UZFS_OGEN", sizeof (uint64_t), SA_UINT64_ARRAY, 12},
	...
	{"UZFS_ZXATTR", sizeof (uint64_t), SA_UINT64_ARRAY, 17},
